...
//show all team members their med and short term skills
              ...
              child: StreamBuilder(
                  ...
                  builder: (BuildContext context,
                    ...
                    for (int i = 0; i < snapshot.data!.docs.length; i++) {
                      ...
                      chartItems.add(
                        ChartSampleData(
                          x: 25.0 / i, //team short term assessm avr
                          y: 0.11, //team mid term assessm avr
                          yValue: -2.03, //team short term assessm avr
                          thirdSeriesYValue: 0.10, //team short term assessm avr
                        ),
  ...
  // List<ScatterSeries<ChartSampleData, double>> _getDefaultScatterSeries() {
  //   // final List<ChartSampleData> chartData = <ChartSampleData>[
  //   //   ChartSampleData(
  //   //       x: DateTime(2006, 1, 1),
  //   //       y: 0.01,
  ...
  //   return <ScatterSeries<ChartSampleData, double>>[
